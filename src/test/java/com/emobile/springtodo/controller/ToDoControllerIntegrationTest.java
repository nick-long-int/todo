...
public class ToDoControllerIntegrationTest {
    ...
    void testGetAllTasksSuccess() throws IOException {
        ...
        ResponseEntity<PageResponse> result = restTemplate.exchange(baseUrl() + "?size={size}&page={page}",
            HttpMethod.GET,
            null,
        ...
        assertEquals(HttpStatus.OK, result.getStatusCode());
        PageResponse pageResponse = result.getBody();
        assertEquals(size, pageResponse.getTasks().size());
    }
    ...
    void testUpdateTaskSuccess() throws IOException {
        ...
        expectedDto.setStatus(TaskStatus.UPDATED.name());
        ...
        assertEquals(TaskStatus.UPDATED.name(), actualDto.getStatus());
    }
